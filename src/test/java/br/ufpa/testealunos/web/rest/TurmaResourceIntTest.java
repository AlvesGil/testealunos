...
import br.ufpa.testealunos.domain.Turma;
import br.ufpa.testealunos.repository.TurmaRepository;
...
public class TurmaResourceIntTest {
    ...
    private static final TipoTurma DEFAULT_TIPO = TipoTurma.BASICO;
    private static final TipoTurma UPDATED_TIPO = TipoTurma.MEDIO;
    ...
    public void createTurma() throws Exception {
        ...
        assertThat(testTurma.getCod()).isEqualTo(DEFAULT_COD);
        assertThat(testTurma.getTipo()).isEqualTo(DEFAULT_TIPO);
    }
    ...
    public void updateTurma() throws Exception {
        ...
        assertThat(testTurma.getCod()).isEqualTo(UPDATED_COD);
        assertThat(testTurma.getTipo()).isEqualTo(UPDATED_TIPO);
    }
